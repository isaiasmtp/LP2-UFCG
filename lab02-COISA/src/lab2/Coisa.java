...
public class Coisa {
	...
	public static void main(String[] args) {
		...
		*/
		...
		/*
        Disciplina prog2 = new Disciplina("PROGRAMACAO 2",2,new int[] {6,4});
        ...
        */
        ...
        cantinaSeuMatias.cadastraLanche(2, 500, "muamba 1");
        cantinaSeuMatias.cadastraLanche(1, 500, "leseira 2");
        cantinaSeuMatias.cadastraLanche(2, 500, "muamba 3");
        cantinaSeuMatias.cadastraLanche(1, 500, "leseira 4");
        cantinaSeuMatias.cadastraLanche(2, 500, "muamba 5");
        cantinaSeuMatias.cadastraLanche(1, 500, "leseira 6");
        cantinaSeuMatias.pagaConta(200);
        System.out.println(cantinaSeuMatias.getFaltaPagar());
        System.out.println(cantinaSeuMatias.toString());
